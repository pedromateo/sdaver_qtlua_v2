...
#include "../CSU_Qt-1.0-Linux/src/csu/qt/widgets/shadow_widget/sw_highlighter.h"
...
void csu::qt::widgets::shadow_frame::Highlighter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData csu::qt::widgets::shadow_frame::Highlighter::staticMetaObjectExtraData = {
...
const QMetaObject csu::qt::widgets::shadow_frame::Highlighter::staticMetaObject = {
    { &ShadowWidget::staticMetaObject, qt_meta_stringdata_csu__qt__widgets__shadow_frame__Highlighter,
      qt_meta_data_csu__qt__widgets__shadow_frame__Highlighter, &staticMetaObjectExtraData }
};
