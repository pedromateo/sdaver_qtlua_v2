...
#ifndef BASIC_TAB_EVALUATOR_H
#define BASIC_TAB_EVALUATOR_H
...
class BasicTabEvaluator : public AbstractUIEvaluator {

public:
    //Constructor
    BasicTabEvaluator();

    virtual ~BasicTabEvaluator();
