...
#ifndef BASIC_SLIDER_EVALUATOR_H
#define BASIC_SLIDER_EVALUATOR_H
...
class BasicSliderEvaluator : public AbstractUIEvaluator {

public:
    //Constructor
    BasicSliderEvaluator();

    virtual ~BasicSliderEvaluator();
...
#endif //BASIC_SLIDER_EVALUATOR_H
