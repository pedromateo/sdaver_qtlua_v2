...
#ifndef BASIC_EXCLUDABLE_EVALUATOR_H
#define BASIC_EXCLUDABLE_EVALUATOR_H
...
class BasicExcludableEvaluator : public AbstractUIEvaluator
{
public:
    //Constructor
    BasicExcludableEvaluator();    

    virtual ~BasicExcludableEvaluator();

    //Evaluation Methods
    virtual void evaluate(AbstractWidget * , AbstractUI *);

private:
    typedef std::map<std::string,bool> Cache;
    Cache cache_;
...
#endif //BASIC_EXCLUDABLE_EVALUATOR_H
