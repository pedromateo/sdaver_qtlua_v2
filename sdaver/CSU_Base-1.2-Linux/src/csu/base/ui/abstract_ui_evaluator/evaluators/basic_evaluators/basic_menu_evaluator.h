...
#ifndef BASIC_MENU_EVALUATOR_H
#define BASIC_MENU_EVALUATOR_H
...
class BasicMenuEvaluator : public AbstractUIEvaluator {

public:
    //Constructor
    BasicMenuEvaluator();

    virtual ~BasicMenuEvaluator();
