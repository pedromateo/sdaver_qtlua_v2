...
*
*/
#ifndef PANEL_DISPLAY_EVALUATOR_H
#define PANEL_DISPLAY_EVALUATOR_H
...
class PanelDisplayEvaluator  : public AbstractUIEvaluator
{
public:
    //Constructor
    PanelDisplayEvaluator();

    virtual ~PanelDisplayEvaluator();
...
#endif // PANEL_DISPLAY_EVALUATOR_H
