...
#ifndef GRAPHICAL_WIDGET_EVALUATOR_H
#define GRAPHICAL_WIDGET_EVALUATOR_H
...
class GraphicalWidgetEvaluator : public AbstractUIEvaluator
{
public:
    //Constructor
    GraphicalWidgetEvaluator();

    virtual ~GraphicalWidgetEvaluator();
...
#endif // GRAPHICAL_WIDGET_EVALUATOR_H
